...
<div class="container mt-5">
    <h1 class="mb-5 text-center text-white bg-dark py-3 rounded shadow-lg" style="font-size: 2rem;">Thêm Nhân Viên</h1>
                ...
                <div class="card-body">
                    <form action="{{ route('nhan-vien.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('CaLam') is-invalid @enderror" name="CaLam" id="CaLam" required>
