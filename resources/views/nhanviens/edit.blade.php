...
@section('content')
<div class="container">
    <h1 class="mb-5 text-center text-white bg-dark py-3 rounded shadow-lg" style="font-size: 2rem;">Chỉnh Sửa Nhân Viên</h1>
    <form action="{{ route('nhan-vien.update', $nhanvien->MaNhanVien) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="MaNhanVien" name="MaNhanVien" value="{{ $nhanvien->MaNhanVien }}" readonly>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="SoDienThoai" name="SoDienThoai" value="{{ $nhanvien->SoDienThoai }}" required>
        </div>
        <div class="mb-3">
